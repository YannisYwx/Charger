...
class MsgManager extends Handler implements Comparator<AppMsg> {
    ...
    private static WeakHashMap<AppCompatActivity, MsgManager> sManagers;
    ...
    /**
     * @return A {@link MsgManager} instance to be used for given {@link AppCompatActivity}.
     */
    static synchronized MsgManager obtain(AppCompatActivity activity) {
        if (sManagers == null) {
            sManagers = new WeakHashMap<AppCompatActivity, MsgManager>(1);
        }
    ...
    static void ensureReleaseOnDestroy(AppCompatActivity activity) {
    ...
    static synchronized void release(AppCompatActivity activity) {
        if (sManagers != null) {
    ...
    static class ReleaseCallbacksIcs implements ActivityLifecycleCallbacks, ReleaseCallbacks {
        ...
        public void onActivityDestroyed(Activity activity) {
            release((AppCompatActivity) activity);
        }
        @Override
