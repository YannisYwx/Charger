...
public class AppMsg {
     ...
     * -Usually until an invocation of {@link #cancel()}, {@link #cancelAll(AppCompatActivity)},
     * {@link #cancelAll()} or {@link AppCompatActivity#onDestroy()}-,
     *
     ...
     *
     * @param activity {@link AppCompatActivity} to use.
     */
    public AppMsg(AppCompatActivity activity) {
        mActivity =  activity;
    }
     ...
     */
    public static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style) {
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, OnClickListener clickListener) {
        return makeText(context, text, style, R.layout.app_msg);
    }
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, float textSize) {
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, float textSize, OnClickListener clickListener) {
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, int layoutId) {
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, int layoutId, OnClickListener clickListener) {
        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(layoutId, null);
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, int layoutId, float textSize, OnClickListener clickListener) {
        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(layoutId, null);
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, int layoutId, float textSize) {
        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(layoutId, null);
     ...
     * @param style    The style with a background and a duration.
     */
    public static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, View customView) {
     ...
     * @param style    The style with a background and a duration.
     */
    public static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, View customView, OnClickListener clickListener) {
     ...
     */
    private static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, View view, boolean floating) {
     ...
     * @param floating true if it'll float.
     */
    private static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, View view, boolean floating, OnClickListener clickListener) {
     ...
     * @param floating true if it'll float.
     */
    private static AppMsg makeText(AppCompatActivity context, CharSequence text, Style style, View view, boolean floating, float textSize) {
     ...
     * @param floating true if it'll float.
     */
    public static AppMsg makeText(AppCompatActivity context, int resId, Style style, View customView, boolean floating) {
     ...
     */
    public static AppMsg makeText(AppCompatActivity context, int resId, Style style)
     ...
     * @throws Resources.NotFoundException if the resource can't be found.
     */
    public static AppMsg makeText(AppCompatActivity context, int resId, Style style, int layoutId)
            throws Resources.NotFoundException {
    ...
    /**
     * Cancels all queued {@link AppMsg}s, in given {@link AppCompatActivity}.
     * If there is a {@link AppMsg} displayed currently, it will be the last one displayed.
     * @param activity
     */
    public static void cancelAll(AppCompatActivity activity) {
