    ...
    public static String getHotspotAddress(Context context) {
        ...
        if (wifiManager != null) {
            if (!wifiManager.isWifiEnabled()) {
                ...
                hotspotAddress = intToIp(dhcpinfo.serverAddress);
            }
        }
    ...
    public static String getLocalAddress(Context context) {
        ...
        if (wifiManager != null) {
            if (!wifiManager.isWifiEnabled()) {
                ...
                localAddress = intToIp(wifiInfo.getIpAddress());
            }
        }
        return localAddress;
    }
